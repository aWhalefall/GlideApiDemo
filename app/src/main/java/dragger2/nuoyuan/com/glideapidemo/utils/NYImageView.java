...
public class NYImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public NYImageView(Context context) {
        super(context);
    }

    public NYImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NYImageView(Context context, AttributeSet attrs, int defStyleAttr) {
